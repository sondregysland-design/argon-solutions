        ...
        <div className="grid gap-8 md:grid-cols-3">
          ...
          <div>
            ...
            <div className="mt-4 flex gap-3">
              <a href="https://www.instagram.com/argonsolutions/" target="_blank" rel="noopener noreferrer" className="text-text-light hover:text-primary transition-colors" aria-label="Instagram">
              ...
              <a href="https://www.linkedin.com/company/argon-solutions-no/" target="_blank" rel="noopener noreferrer" className="text-text-light hover:text-primary transition-colors" aria-label="LinkedIn">
